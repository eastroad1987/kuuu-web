  ...
  return (
    <div className="max-w-sm overflow-hidden rounded-lg bg-white shadow-lg">
      <div className="relative h-48 w-full overflow-hidden">
        {displayCard.badge && (
          <div className={`absolute right-2 top-2 z-10 rounded-full ${displayCard.badgeColor || 'bg-blue-500'} px-2 py-1 text-xs font-bold text-white`}>
            {displayCard.badge}
          </div>
        )}
        <Image
      ...
      <div className="px-6 py-4">
        ...
        <h3 className="mb-2 text-sm font-medium text-gray-600">{displayCard.subtitle}</h3>
